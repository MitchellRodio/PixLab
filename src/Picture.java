...
public class Picture extends SimplePicture {
  ...
  public void negate() {
    int negateRed = 255 - this.red;
    int negateGreen = 255 - this.green;
    int negateBlue = 255 - this.blue;
  ...
  /**
     * Method that mirrors the picture around a vertical mirror in the center ofo
  ...
  public static void myCopy(Picture fromPic, int startRow, int startCol) {
  Pixel fromPixel = 200;
  Pixel toPixel = 600;
  Pixel[][] toPixels = this.getPixels2D();
  Pixel[][] fromPixels = fromPic.getPixels2D();
  ...
  public void mirrorGull() {
    int mirrorPoint = 276;
    Pixel leftPixel = 200;
    Pixel rightPixel = 400;
    int count = 0;
    Pixel[][] pixels = this.getPixels2D();

    // loop through the rows
    for (int row = 30; row < 50; row++) {
      // loop from 13 to just before the mirror point
      for (int col = 13; col < mirrorPoint; col++) {
  ...
  public void mirrorVerticalRightToLeft {
    ...
    Pixel[][] pixels this.getPixels2D();
    Pixel leftPixel = null;
    Puxel rightPixel = null;
    int width = fixels[0].length;
    for (int row = 0; row < pixels.length; row++) {
